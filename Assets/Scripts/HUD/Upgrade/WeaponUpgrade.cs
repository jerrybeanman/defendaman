			...
			print (monies);
				switch(_inventory.inventory_item_list[0].id){
					...
					case 1:
						...
						_inventory.UseResources(Constants.GOLD_RES,50);
					...
					case 13:
						if(MyResources[Constants.GOLD_RES]>=200){
							_inventory.DestroyInventoryItem(0,1);
							_inventory.AddItem(14,1);		
							_inventory.UseResources(Constants.GOLD_RES,200);	
							print (MyResources[Constants.GOLD_RES]);
						}
						break;
					//If two handguns... upgrade to 3?....
					case 14:
						if(MyResources[Constants.GOLD_RES]>=400){
							_inventory.DestroyInventoryItem(0,1);
							_inventory.AddItem(15,1);	
							_inventory.UseResources(Constants.GOLD_RES,400);
							print (MyResources[Constants.GOLD_RES]);
						}
						break;
